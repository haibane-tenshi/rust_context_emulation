...
impl<'alloc, 'my_vec> CxFnOnce<()> for allocate_into<'alloc, 'my_vec> {
    type Output<'_0, '_1, '_2, '_3> = ();
    type Context<'_0, '_1, '_2, '_3> =
        MakeContext<(&'alloc __alloc, &'my_vec mut __my_vec<'alloc>)>;
...
impl<'alloc, 'my_vec> CxFnMut<()> for allocate_into<'alloc, 'my_vec> {
...
impl<'alloc, 'my_vec> CxFn<()> for allocate_into<'alloc, 'my_vec> {
