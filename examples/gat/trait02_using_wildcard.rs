...
where
    ...
    for<'_0, '_1, '_2, '_3, 't, 's> <GenericFnContext<'_0, '_1, '_2, '_3, 't, T> as Reborrow>::Output<'s>: Coerce<
        <<T as UsefulWork>::wildcard_method as CxFnOnce<(&'t T,)>>::Context<'_0, '_1, '_2, '_3>,
    >,
...
where
    ...
    for<'_0, '_1, '_2, '_3, 'at, 's> <GenericFnContext<'_0, '_1, '_2, '_3, 'at, T> as Reborrow>::Output<'s>:
        Coerce<
